...
class Moderation(commands.Cog):
    ...
    async def mute(self, interaction:discord.Interaction, member : discord.Member = None, *, reason: str = "Unspecified"):
        if member == None:
            Mute = discord.Embed(
                title = "Mute",
    ...
    @app_commands.command(name = "unban", description = "Unbans the mentioned user (Has to be discord user ID)")
    @commands.has_permissions(ban_members = True)
