...
class Economy(commands.Cog):
    ...
    @app_commands.command(name = "add", description = "Add set amount of coins to your balance")
    @commands.is_owner()
    async def add(self, interaction:discord.Interaction, member : discord.Member = None, amount: int = None):
        user_id = str(interaction.user.id)
    ...
    @app_commands.command(name = "subtract", description = "Subtract set amount of coins from your balance")
    @commands.is_owner()
    async def subtract(self, interaction:discord.Interaction, member : discord.Member = None, amount: int = None):
        user_id = str(interaction.user.id)
    ...
    @app_commands.command(name = "hourly", description = "Gain 10 coins every time you use this command")
    ...
    @app_commands.command(name = "devskip", description = "Skip all cooldowns of the mentioned user")
    @commands.is_owner()
    async def devskip(self, interaction:discord.Interaction, user: discord.User):
        ...
        Skip2 = discord.Embed(
            ...
            description = (f'{user.name}\'s fishing and hunting cooldowns have been skipped'),
            colour = discord.Colour.green())

        Skip3 = discord.Embed(
            title = "Cooldowns Skipped",
            description = (f'{user.name}\'s fishing and hourly cooldowns have been skipped'),
            colour = discord.Colour.green())
        ...
        Skip5 = discord.Embed(
            title = "Cooldowns Skipped",
            description = (f'{user.name}\'s hunting and hourly cooldowns have been skipped'),
            colour = discord.Colour.green())
